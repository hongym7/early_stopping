...
flags.DEFINE_string(
    'model_dir', '/home/hong/dl_data/pet/models/model/train_earlyStopping', 'Path to output model directory '
    'where event and checkpoint files will be written.')
flags.DEFINE_string('pipeline_config_path', '/home/hong/dl_data/pet/models/model/faster_rcnn_inception_resnet_v2_atrous_pets.config', 'Path to pipeline config '
                    'file.')
flags.DEFINE_integer('num_train_steps', 100000, 'Number of train steps.')
...
def main(unused_argv):
  ...
  if FLAGS.checkpoint_dir:
    ...
    early_stopping_hook = EarlyStoppingHook(monitor='total_loss', patience=300)
